...
<style>
	...
	:global(.rich-text-display h4),
	:global(.rich-text-display h5),
	:global(.rich-text-display h6) {
		margin: 16px 0 8px 0;
		font-weight: 600;
	}
